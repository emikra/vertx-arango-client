...
@DataObject
public class CreateSkipListIndexOptions extends CreateIndexOptions {

    public final String FIELD_FIELDS = "fields";
    public final String FIELD_UNIQUE = "unique";
    public final String FIELD_SPARSE = "sparse";

    public CreateSkipListIndexOptions() {
        this(new JsonObject());
    }

    public CreateSkipListIndexOptions(CreateSkipListIndexOptions options) {
        this(options.toJson());
    }

    public CreateSkipListIndexOptions(JsonObject json) {
        super(json);
        this.setType("skiplist");
    }

    public CreateSkipListIndexOptions setUnique(Boolean isUnique) {
    ...
    public CreateSkipListIndexOptions setSparse(Boolean isSparse) {
    ...
    public CreateSkipListIndexOptions addField(String field) {
